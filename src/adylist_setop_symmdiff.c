...
/*
	...
	printf("\n");
*/
	// Operación de Diferencia Simétrica entre listas de adyacencia
	ALREP * listadyResult = adylistSymmetricDifferenceOperation(A, B);
...
/*
	printf("Lista de Adyacencia de la Diferencia Simétrica\n");
	printf("Nodes: %d\n", nodes);
	printf("Edges: %ld\n", edgesResult[0]);
