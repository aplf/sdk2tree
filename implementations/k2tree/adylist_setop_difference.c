...
/*
	...
	printf("\n");
*/
	// Operación de Diferencia entre listas de adyacencia
//	ulong edgesResult[1] = {0};
//	int* listadyResult = adylistDifferenceOperation(listadyA, listadyB, nodes, edgesA, edgesB, edgesResult);
	ALREP * listadyResult = adylistDifferenceOperation(A, B);
	...
	// Desplegando Resultado de la Diferencia
/*
	printf("Lista de Adyacencia de la Diferencia\n");
	printf("Nodes: %d\n", nodes);
	printf("Edges: %ld\n", edgesResult[0]);
